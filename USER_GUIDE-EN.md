...
This guide covers Apipoj Skills **v6.5.0** for Claude Code, Codex, and Agent Skills-compatible tools.
...
Release v6.5.0 ships **40 skills**, each available as a command.
...
```text
/spk:check-release Check v6.5.0 readiness without committing, tagging, or publishing anything.
```
