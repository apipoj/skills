...
This guide covers Apipoj Skills **v6.6.3** for Claude Code, Codex, and Agent Skills-compatible tools.
...
```text
/spk:check-release Check v6.6.3 readiness without committing, tagging, or publishing anything.
```
