...
This guide covers Apipoj Skills **v6.6.1** for Claude Code, Codex, and Agent Skills-compatible tools.
...
Release v6.6.1 ships **40 skills**, each available as a command.
...
```text
/spk:check-release Check v6.6.1 readiness without committing, tagging, or publishing anything.
```
