---
name: scoped-tests
description: จับคู่ไฟล์ที่เปลี่ยนกับชุดทดสอบที่เล็กที่สุดอย่างมีเหตุผล รันเพื่อ feedback เร็ว เปิดเผย path ที่จับคู่ไม่ได้ และบังคับ full suite ก่อนจบงาน
---
# scoped-tests
