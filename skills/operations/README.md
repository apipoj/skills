...
- [`release-check`](./release-check/SKILL.md) — รัน gate ความพร้อม release ทั้งหมดของ repo ตรวจ version และ generated artifacts ให้สอดคล้อง และรายงาน blocker โดยไม่ publish _(manual-only)_
