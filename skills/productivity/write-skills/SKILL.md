---
name: write-skills
description: เขียนหรือปรับ skill ให้เรียกใช้ถูก ทำงานสม่ำเสมอ และไม่ใส่คำสั่งเกินจำเป็น
disable-model-invocation: true
---
# เขียน skill ให้ใช้ได้จริง
...
ใช้หลัก predictability, progressive disclosure และการลด prompt noise เพื่อเขียน skill ที่ไว้ใจได้
