...
`ask-me` ถามผู้ใช้ทีละหนึ่ง decision ต่อข้อความแล้วส่งต่องานอื่นแบบมี gate เท่านั้น — ถ้าต้องถามทั้ง frontier รวดเดียวเป็นรอบ ให้ใช้ `asking` แทน และถ้าต้องการเอกสารคำถามส่งให้บุคคลที่สามตอบแทนโดยไม่ถามผู้ใช้เอง ให้ใช้ `to-questionnaire`
