...
description: ชื่อเดิมชั่วคราวสำหรับ setup; แจ้งชื่อใหม่แล้วใช้ contract เดียวกันโดยไม่เพิ่มสิทธิ์หรือขยาย scope
disable-model-invocation: true
---
# ชื่อเดิม: setup-matt-pocock-skills

ใช้ได้ถึงก่อน version 6.0.0 ให้บอกผู้ใช้ว่างานนี้ย้ายไป `setup` แล้วทำตาม approval และ evidence contract เดิม
