...
คู่มือนี้ครอบคลุม Apipoj Skills **v6.6.1** สำหรับ Claude Code, Codex และเครื่องมือที่รองรับ Agent Skills
...
```text
/spk:check-release ตรวจความพร้อม v6.6.1 โดยยังไม่ commit, tag หรือ publish
```
