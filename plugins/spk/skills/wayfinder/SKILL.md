---
name: wayfinder
description: Chart decision tickets for a large foggy effort and resolve them one by one until the path is clear.
disable-model-invocation: true
---

# Chart a Large Foggy Effort
...
Chart decision tickets for a large foggy effort and resolve them one by one until the path is clear.
