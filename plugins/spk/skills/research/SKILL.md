---
name: research
description: Investigate a question using external, primary web sources — not this repository's own knowledge — and store the findings in a cited research doc with verifiable citations.
---
