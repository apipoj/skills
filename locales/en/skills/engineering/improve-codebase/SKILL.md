...
description: Find opportunities to deepen modules, simplify understanding, and test behavior through the right interfaces.
disable-model-invocation: true
---

# Improve Codebase Shape
...
Find opportunities to deepen modules, make them easier to understand, and test through the right interfaces.
